    ...
    <section className='bg-white  '>
      <div className='container flex items-center min-h-screen px-6 py-12 mx-auto'>
        <div>
          ...
          <h1 className='mt-3 text-2xl font-semibold text-gray-800  md:text-3xl'>We cant find that page</h1>
          <p className='mt-4 text-gray-500 '>Sorry, the page you are looking for doesnt exist or has been moved.</p>
